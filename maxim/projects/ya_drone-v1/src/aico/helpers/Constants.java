...
public class Constants {
    ...
    public static final int WHITE_COLOR_THRESHOLD = 220;
    // Количество белых пикселей, необходимых для посадки
    public static final int WHITE_QUANTITY_THRESHOLD = 30000;
    ...
    public static final long WAIT_UNTIL_FLY_FORWARD = 500;
    // Лететь данное время (в милисекундах) вперед без включенного режима отслеживания метки
    public static final long WAIT_UNTIL_DETECT_MODE_ON = 3000;
    ...
    public static final boolean DOUBLE_CAMERA_INITIALIZATION = false;
